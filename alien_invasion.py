...
class AlienInvasion:
    ...
    def _update_aliens(self):
        ...
        self.aliens.update()
         ...
         # Check if all aliens have moved off the screen, then repopulate the fleet
        if all(alien.rect.y > self.settings.screen_height for alien in self.aliens.sprites()):
         self._create_fleet()
    ...
    def run_game(self):
        """Start the loop for the main game"""
        while True:
